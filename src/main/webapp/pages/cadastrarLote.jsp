<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <main class="container py-5 flex-grow-1">
        ...
        <form action="cadastrarLoteServlet" method="POST" class="bg-light p-4 rounded form-custom">
            <!-- Informações do Lote -->
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control cor-input" id="codigoLote" name="codigoLote" placeholder="Digite o código do lote" required>
            </div>
            <div class="mb-3">
                <label for="quantidadeProdutos" class="form-label">Quantidade de Produtos</label>
                <input type="number" class="form-control cor-input" id="quantidadeProdutos" name="quantidadeProdutos" placeholder="Digite a quantidade de produtos" required>
            </div>
            <h4 class="mb-3">Datas</h4>

            <div class="mb-3">
                <label for="dataEntregaLote" class="form-label">Data de Entrega do Lote</label>
                <input type="date" class="form-control cor-input" id="dataEntregaLote" name="dataEntregaLote" required>
            </div>
            <div class="mb-3">
                <label for="dataValidadeProdutos" class="form-label">Data de Validade dos Produtos</label>
                <input type="date" class="form-control cor-input" id="dataValidadeProdutos" name="dataValidadeProdutos" required>
            </div>
            <h4 class="mb-3"> Rastreamento e Identificação</h4>

            <div class="mb-3">
                <label for="qrcode" class="form-label">QR Code</label>
                <input type="text" class="form-control cor-input" id="qrcode" name="qrcode" placeholder="Insira o QR Code" required>
            </div>

            <!-- Botão -->
            <div class="d-grid mt-4">
                <button type="submit" class="btn btn-primary btn-cadastro">Cadastrar Lote</button>
            </div>
        </form>
    </main>
